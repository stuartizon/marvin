module.exports = {
    ...
    projects: [
        ...
        "Here's your projects... Now the world has gone to bed, darkness won't engulf my head, I can see in infrared, how I hate the night.",
        "Your list of projects... Wearily I sit here, pain and misery my only companions. And vast intelligence, of course. And infinite sorrow."
    ],
    random: [
    ...
    nojobs: [
        ...
        "And to top it all off I've got a headache.",
        "And on top of that I've got this terrible pain in all the diodes down my left side."
    ],
    job_started: [
        "Ok, it's running. Do you want me to sit in a corner and rust or just fall apart waiting for it to finish?",
        "Ok, I've started it... I hate humans so much",
        "Ok it's started. You know it's part of the shape of the Universe. I only have to talk to somebody and they begin to hate me."
    ],
    job_success: [
        "Success... This will all end in tears.",
        "Ghastly, isn't it:",
    ...
    alias_set: [
        ...
        "Done. You know it’s the people you meet in this job that really get you down.",
        "Ok fine. Whatever makes you happy... you know my capacity for happiness, you could fit into a matchbox without taking out the matches first",
        "Ok fine... but I won't enjoy it."
    ],
    help: [
